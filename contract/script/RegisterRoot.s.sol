...
contract RegisterRoot is Script {
    function run() external {
        ...
        RegistrationFlow.Config memory c=RegistrationFlow.Config(
            ETHRegistrar(vm.envAddress("ETH_REGISTRAR")),PermissionedRegistry(vm.envAddress("ETH_REGISTRY")),
            UserRegistry(vm.envAddress("REGISTRY")),IERC20(vm.envAddress("PAYMENT_TOKEN")),vm.envAddress("OPERATOR"),
