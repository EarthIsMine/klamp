...
import {CanonicalPoolRegistrar, PoolKey, IPermissionedResolver, IUERC20Factory} from "../../src/CanonicalPoolRegistrar.sol";
...
abstract contract RegistrarFixture is Test {
    ...
    function setUp() public virtual {
        ...
        registrar = new CanonicalPoolRegistrar(IPermissionedResolver(address(resolver)), tokensName, IUERC20Factory(address(factory)), launchers);
    ...
    function nodeFor(address token) internal view returns (bytes32) {
